...
legbox.append("text").text(reg2[i]).style("text-anchor","end").attr("x",xScale(scales[dim][0])+0.43*w).attr("y",yAxisScale(1.58)+i*(leg_h/6)).style("font",`${Math.min(8,h/36)}px arial`).style("fill","navy");}
...
legbox.append("text").text(reg2[i]).style("text-anchor","end").attr("x",xScale(scales[dim][0])+0.82*w).attr("y",yAxisScale(1.58)+(i-5)*(leg_h/6)).style("font",`${Math.min(8,h/36)}px arial`).style("fill","navy");}
